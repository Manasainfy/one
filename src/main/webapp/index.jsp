...
<body>
	...
	<h1 style="color: red; font-size: 40px;" align="center">WE INTEGRATED NEXUS TO JENKINS</h1>
 	<h1 style="color: blue; font-size: 40px;" align="center">Deployed application on two tomcat servers</h1>
	<h1 style="color: Red; font-size: 40px;" align="center">New version</h1>
